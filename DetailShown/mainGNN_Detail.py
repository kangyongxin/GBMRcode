...
from GBMRAgent_Detail import GMRAgent
import matplotlib.pyplot as plt
import numpy as np 
SAVEPATH = './RESULT/GNN_Detail/'
def main(argv=()):
    print("hello world")
    ...
    # #plt.show()
    # plt.savefig(SAVEPATH+"reward_list003.png")
    # reward_list=np.array(reward_list)
    # np.save(SAVEPATH+'reward_list003.npy',reward_list)
    # temp_step_r=[]
    ...
    # #plt.show()
    # plt.savefig(SAVEPATH+"step_r003.png")
    # temp_step_r=np.array(temp_step_r)
    # np.save(SAVEPATH+'temp_step_r003.npy',temp_step_r)
